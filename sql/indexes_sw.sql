...
CREATE INDEX dir_siteinfo_sw_rooturl_gin ON dir_siteinfo_sw USING gin(rooturl gin_trgm_ops);
CREATE INDEX dir_siteinfo_sw_rooturl_btree ON dir_siteinfo_sw (rooturl);
