...
CREATE INDEX dir_siteinfo_lt_rooturl_gin ON dir_siteinfo_lt USING gin(rooturl gin_trgm_ops);
CREATE INDEX dir_siteinfo_lt_rooturl_btree ON dir_siteinfo_lt (rooturl);
