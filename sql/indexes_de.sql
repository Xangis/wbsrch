...
CREATE INDEX dir_siteinfo_de_rooturl_gin ON dir_siteinfo_de USING gin(rooturl gin_trgm_ops);
CREATE INDEX dir_siteinfo_de_rooturl_btree ON dir_siteinfo_de (rooturl);
