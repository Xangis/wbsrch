...
CREATE INDEX dir_siteinfo_sl_rooturl_gin ON dir_siteinfo_sl USING gin(rooturl gin_trgm_ops);
CREATE INDEX dir_siteinfo_sl_rooturl_btree ON dir_siteinfo_sl (rooturl);
