    ...
    def handle(self, *args, **options):
        ...
        if index:
            ...
            if all:
                ...
                query = body={"query": {"multi_match": {"query": keywords, 'fields': ['title^3', 'description^0.5', 'text', 'domain^1.5', 'firstheadtag^4', 'firsth2tag^2', 'firsth3tag^1.2', 'image_alt_tags^0.25', 'keywords^0.1', 'url^0.8', 'image_title_tags^0.2']}}}
