...
from models import DomainSuffix, language_list, blocked_language_list, language_names
...
blocked_locales = [
           ...
           ['uk', 'uk-md', '.md'],
           ['vn', 'vn-vi', '.vn'], 
           ['vn', 'vn-vn', '.vn'], # Mistagged pages are somewhat common.
           ['zh', 'zh-cn', '.cn'],
           ['zh', 'zh-hk', '.hk'],
           ['zh', 'zh-sg', '.sg'],
