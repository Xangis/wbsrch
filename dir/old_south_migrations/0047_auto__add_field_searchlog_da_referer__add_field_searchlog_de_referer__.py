...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchLog_da.referer'
        db.add_column(u'dir_searchlog_da', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_de.referer'
        db.add_column(u'dir_searchlog_de', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_tr.referer'
        db.add_column(u'dir_searchlog_tr', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_cs.referer'
        db.add_column(u'dir_searchlog_cs', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog.referer'
        db.add_column(u'dir_searchlog', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sw.referer'
        db.add_column(u'dir_searchlog_sw', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sv.referer'
        db.add_column(u'dir_searchlog_sv', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sl.referer'
        db.add_column(u'dir_searchlog_sl', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_fr.referer'
        db.add_column(u'dir_searchlog_fr', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sk.referer'
        db.add_column(u'dir_searchlog_sk', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_el.referer'
        db.add_column(u'dir_searchlog_el', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_es.referer'
        db.add_column(u'dir_searchlog_es', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_et.referer'
        db.add_column(u'dir_searchlog_et', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_lt.referer'
        db.add_column(u'dir_searchlog_lt', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_lv.referer'
        db.add_column(u'dir_searchlog_lv', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_pt.referer'
        db.add_column(u'dir_searchlog_pt', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_pl.referer'
        db.add_column(u'dir_searchlog_pl', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_fi.referer'
        db.add_column(u'dir_searchlog_fi', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_no.referer'
        db.add_column(u'dir_searchlog_no', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_nl.referer'
        db.add_column(u'dir_searchlog_nl', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_ro.referer'
        db.add_column(u'dir_searchlog_ro', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_it.referer'
        db.add_column(u'dir_searchlog_it', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_is.referer'
        db.add_column(u'dir_searchlog_is', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_hu.referer'
        db.add_column(u'dir_searchlog_hu', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_hr.referer'
        db.add_column(u'dir_searchlog_hr', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchLog_da.referer'
        db.delete_column(u'dir_searchlog_da', 'referer')

        # Deleting field 'SearchLog_de.referer'
        db.delete_column(u'dir_searchlog_de', 'referer')

        # Deleting field 'SearchLog_tr.referer'
        db.delete_column(u'dir_searchlog_tr', 'referer')

        # Deleting field 'SearchLog_cs.referer'
        db.delete_column(u'dir_searchlog_cs', 'referer')

        # Deleting field 'SearchLog.referer'
        db.delete_column(u'dir_searchlog', 'referer')

        # Deleting field 'SearchLog_sw.referer'
        db.delete_column(u'dir_searchlog_sw', 'referer')

        # Deleting field 'SearchLog_sv.referer'
        db.delete_column(u'dir_searchlog_sv', 'referer')

        # Deleting field 'SearchLog_sl.referer'
        db.delete_column(u'dir_searchlog_sl', 'referer')

        # Deleting field 'SearchLog_fr.referer'
        db.delete_column(u'dir_searchlog_fr', 'referer')

        # Deleting field 'SearchLog_sk.referer'
        db.delete_column(u'dir_searchlog_sk', 'referer')

        # Deleting field 'SearchLog_el.referer'
        db.delete_column(u'dir_searchlog_el', 'referer')

        # Deleting field 'SearchLog_es.referer'
        db.delete_column(u'dir_searchlog_es', 'referer')

        # Deleting field 'SearchLog_et.referer'
        db.delete_column(u'dir_searchlog_et', 'referer')

        # Deleting field 'SearchLog_lt.referer'
        db.delete_column(u'dir_searchlog_lt', 'referer')

        # Deleting field 'SearchLog_lv.referer'
        db.delete_column(u'dir_searchlog_lv', 'referer')

        # Deleting field 'SearchLog_pt.referer'
        db.delete_column(u'dir_searchlog_pt', 'referer')

        # Deleting field 'SearchLog_pl.referer'
        db.delete_column(u'dir_searchlog_pl', 'referer')

        # Deleting field 'SearchLog_fi.referer'
        db.delete_column(u'dir_searchlog_fi', 'referer')

        # Deleting field 'SearchLog_no.referer'
        db.delete_column(u'dir_searchlog_no', 'referer')

        # Deleting field 'SearchLog_nl.referer'
        db.delete_column(u'dir_searchlog_nl', 'referer')

        # Deleting field 'SearchLog_ro.referer'
        db.delete_column(u'dir_searchlog_ro', 'referer')

        # Deleting field 'SearchLog_it.referer'
        db.delete_column(u'dir_searchlog_it', 'referer')

        # Deleting field 'SearchLog_is.referer'
        db.delete_column(u'dir_searchlog_is', 'referer')

        # Deleting field 'SearchLog_hu.referer'
        db.delete_column(u'dir_searchlog_hu', 'referer')

        # Deleting field 'SearchLog_hr.referer'
        db.delete_column(u'dir_searchlog_hr', 'referer')
