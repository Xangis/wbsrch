...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SiteInfo_eu'
        db.create_table(u'dir_siteinfo_eu', (
        ...
        db.send_create_signal(u'dir', ['SiteInfo_eu'])

        # Adding model 'SiteInfo_gl'
        db.create_table(u'dir_siteinfo_gl', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rooturl', self.gf('django.db.models.fields.CharField')(max_length=260, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=2048, blank=True)),
            ('pagetitle', self.gf('django.db.models.fields.CharField')(max_length=260, null=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_gl'])


    def backwards(self, orm):
        # Deleting model 'SiteInfo_eu'
        db.delete_table(u'dir_siteinfo_eu')

        # Deleting model 'SiteInfo_gl'
        db.delete_table(u'dir_siteinfo_gl')
