...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DomainInfo', fields ['url']
        db.create_index(u'dir_domaininfo', ['url'])

        # Adding index on 'ExcludedSite', fields ['url']
        db.create_index('excluded_site', ['url'])


    def backwards(self, orm):
        # Removing index on 'ExcludedSite', fields ['url']
        db.delete_index('excluded_site', ['url'])

        # Removing index on 'DomainInfo', fields ['url']
        db.delete_index(u'dir_domaininfo', ['url'])
