...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainInfo.uses_language_subdirs'
        db.add_column(u'dir_domaininfo', 'uses_language_subdirs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DomainInfo.max_urls'
        db.add_column(u'dir_domaininfo', 'max_urls',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainInfo.uses_language_subdirs'
        db.delete_column(u'dir_domaininfo', 'uses_language_subdirs')

        # Deleting field 'DomainInfo.max_urls'
        db.delete_column(u'dir_domaininfo', 'max_urls')
