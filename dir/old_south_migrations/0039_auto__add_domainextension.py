...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DomainExtension'
        db.create_table(u'dir_domainextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('extension', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('default_language', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('no_new_domain_urls', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'dir', ['DomainExtension'])


    def backwards(self, orm):
        # Deleting model 'DomainExtension'
        db.delete_table(u'dir_domainextension')
