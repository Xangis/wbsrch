...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExcludedSite.exclude_subdomains'
        db.add_column('excluded_site', 'exclude_subdomains',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExcludedSite.exclude_subdomains'
        db.delete_column('excluded_site', 'exclude_subdomains')
