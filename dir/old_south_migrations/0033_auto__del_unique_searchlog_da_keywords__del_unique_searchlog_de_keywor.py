...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SearchLog_hr', fields ['keywords']
        db.delete_unique(u'dir_searchlog_hr', ['keywords'])

        # Removing unique constraint on 'SearchLog_hu', fields ['keywords']
        db.delete_unique(u'dir_searchlog_hu', ['keywords'])

        # Removing unique constraint on 'SearchLog_is', fields ['keywords']
        db.delete_unique(u'dir_searchlog_is', ['keywords'])

        # Removing unique constraint on 'SearchLog_it', fields ['keywords']
        db.delete_unique(u'dir_searchlog_it', ['keywords'])

        # Removing unique constraint on 'SearchLog_ro', fields ['keywords']
        db.delete_unique(u'dir_searchlog_ro', ['keywords'])

        # Removing unique constraint on 'SearchLog_nl', fields ['keywords']
        db.delete_unique(u'dir_searchlog_nl', ['keywords'])

        # Removing unique constraint on 'SearchLog_no', fields ['keywords']
        db.delete_unique(u'dir_searchlog_no', ['keywords'])

        # Removing unique constraint on 'SearchLog_pl', fields ['keywords']
        db.delete_unique(u'dir_searchlog_pl', ['keywords'])

        # Removing unique constraint on 'SearchLog_pt', fields ['keywords']
        db.delete_unique(u'dir_searchlog_pt', ['keywords'])

        # Removing unique constraint on 'SearchLog_lv', fields ['keywords']
        db.delete_unique(u'dir_searchlog_lv', ['keywords'])

        # Removing unique constraint on 'SearchLog_lt', fields ['keywords']
        db.delete_unique(u'dir_searchlog_lt', ['keywords'])

        # Removing unique constraint on 'SearchLog_et', fields ['keywords']
        db.delete_unique(u'dir_searchlog_et', ['keywords'])

        # Removing unique constraint on 'SearchLog_es', fields ['keywords']
        db.delete_unique(u'dir_searchlog_es', ['keywords'])

        # Removing unique constraint on 'SearchLog_el', fields ['keywords']
        db.delete_unique(u'dir_searchlog_el', ['keywords'])

        # Removing unique constraint on 'SearchLog_sk', fields ['keywords']
        db.delete_unique(u'dir_searchlog_sk', ['keywords'])

        # Removing unique constraint on 'SearchLog_fr', fields ['keywords']
        db.delete_unique(u'dir_searchlog_fr', ['keywords'])

        # Removing unique constraint on 'SearchLog_fi', fields ['keywords']
        db.delete_unique(u'dir_searchlog_fi', ['keywords'])

        # Removing unique constraint on 'SearchLog', fields ['keywords']
        db.delete_unique(u'dir_searchlog', ['keywords'])

        # Removing unique constraint on 'SearchLog_sv', fields ['keywords']
        db.delete_unique(u'dir_searchlog_sv', ['keywords'])

        # Removing unique constraint on 'SearchLog_sw', fields ['keywords']
        db.delete_unique(u'dir_searchlog_sw', ['keywords'])

        # Removing unique constraint on 'SearchLog_si', fields ['keywords']
        db.delete_unique(u'dir_searchlog_si', ['keywords'])

        # Removing unique constraint on 'SearchLog_cs', fields ['keywords']
        db.delete_unique(u'dir_searchlog_cs', ['keywords'])

        # Removing unique constraint on 'SearchLog_tr', fields ['keywords']
        db.delete_unique(u'dir_searchlog_tr', ['keywords'])

        # Removing unique constraint on 'SearchLog_de', fields ['keywords']
        db.delete_unique(u'dir_searchlog_de', ['keywords'])

        # Removing unique constraint on 'SearchLog_da', fields ['keywords']
        db.delete_unique(u'dir_searchlog_da', ['keywords'])


    def backwards(self, orm):
        # Adding unique constraint on 'SearchLog_da', fields ['keywords']
        db.create_unique(u'dir_searchlog_da', ['keywords'])

        # Adding unique constraint on 'SearchLog_de', fields ['keywords']
        db.create_unique(u'dir_searchlog_de', ['keywords'])

        # Adding unique constraint on 'SearchLog_tr', fields ['keywords']
        db.create_unique(u'dir_searchlog_tr', ['keywords'])

        # Adding unique constraint on 'SearchLog_cs', fields ['keywords']
        db.create_unique(u'dir_searchlog_cs', ['keywords'])

        # Adding unique constraint on 'SearchLog_si', fields ['keywords']
        db.create_unique(u'dir_searchlog_si', ['keywords'])

        # Adding unique constraint on 'SearchLog_sw', fields ['keywords']
        db.create_unique(u'dir_searchlog_sw', ['keywords'])

        # Adding unique constraint on 'SearchLog_sv', fields ['keywords']
        db.create_unique(u'dir_searchlog_sv', ['keywords'])

        # Adding unique constraint on 'SearchLog', fields ['keywords']
        db.create_unique(u'dir_searchlog', ['keywords'])

        # Adding unique constraint on 'SearchLog_fi', fields ['keywords']
        db.create_unique(u'dir_searchlog_fi', ['keywords'])

        # Adding unique constraint on 'SearchLog_fr', fields ['keywords']
        db.create_unique(u'dir_searchlog_fr', ['keywords'])

        # Adding unique constraint on 'SearchLog_sk', fields ['keywords']
        db.create_unique(u'dir_searchlog_sk', ['keywords'])

        # Adding unique constraint on 'SearchLog_el', fields ['keywords']
        db.create_unique(u'dir_searchlog_el', ['keywords'])

        # Adding unique constraint on 'SearchLog_es', fields ['keywords']
        db.create_unique(u'dir_searchlog_es', ['keywords'])

        # Adding unique constraint on 'SearchLog_et', fields ['keywords']
        db.create_unique(u'dir_searchlog_et', ['keywords'])

        # Adding unique constraint on 'SearchLog_lt', fields ['keywords']
        db.create_unique(u'dir_searchlog_lt', ['keywords'])

        # Adding unique constraint on 'SearchLog_lv', fields ['keywords']
        db.create_unique(u'dir_searchlog_lv', ['keywords'])

        # Adding unique constraint on 'SearchLog_pt', fields ['keywords']
        db.create_unique(u'dir_searchlog_pt', ['keywords'])

        # Adding unique constraint on 'SearchLog_pl', fields ['keywords']
        db.create_unique(u'dir_searchlog_pl', ['keywords'])

        # Adding unique constraint on 'SearchLog_no', fields ['keywords']
        db.create_unique(u'dir_searchlog_no', ['keywords'])

        # Adding unique constraint on 'SearchLog_nl', fields ['keywords']
        db.create_unique(u'dir_searchlog_nl', ['keywords'])

        # Adding unique constraint on 'SearchLog_ro', fields ['keywords']
        db.create_unique(u'dir_searchlog_ro', ['keywords'])

        # Adding unique constraint on 'SearchLog_it', fields ['keywords']
        db.create_unique(u'dir_searchlog_it', ['keywords'])

        # Adding unique constraint on 'SearchLog_is', fields ['keywords']
        db.create_unique(u'dir_searchlog_is', ['keywords'])

        # Adding unique constraint on 'SearchLog_hu', fields ['keywords']
        db.create_unique(u'dir_searchlog_hu', ['keywords'])

        # Adding unique constraint on 'SearchLog_hr', fields ['keywords']
        db.create_unique(u'dir_searchlog_hr', ['keywords'])
