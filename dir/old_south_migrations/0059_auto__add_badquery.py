...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BadQuery'
        db.create_table(u'dir_badquery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(max_length=260)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['BadQuery'])


    def backwards(self, orm):
        # Deleting model 'BadQuery'
        db.delete_table(u'dir_badquery')
