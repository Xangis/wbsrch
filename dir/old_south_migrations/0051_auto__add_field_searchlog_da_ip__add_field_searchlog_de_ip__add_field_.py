...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchLog_da.ip'
        db.add_column(u'dir_searchlog_da', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_de.ip'
        db.add_column(u'dir_searchlog_de', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_tr.ip'
        db.add_column(u'dir_searchlog_tr', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_cs.ip'
        db.add_column(u'dir_searchlog_cs', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog.ip'
        db.add_column(u'dir_searchlog', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sw.ip'
        db.add_column(u'dir_searchlog_sw', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sv.ip'
        db.add_column(u'dir_searchlog_sv', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sl.ip'
        db.add_column(u'dir_searchlog_sl', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_fr.ip'
        db.add_column(u'dir_searchlog_fr', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sk.ip'
        db.add_column(u'dir_searchlog_sk', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_el.ip'
        db.add_column(u'dir_searchlog_el', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_es.ip'
        db.add_column(u'dir_searchlog_es', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_et.ip'
        db.add_column(u'dir_searchlog_et', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_lt.ip'
        db.add_column(u'dir_searchlog_lt', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_lv.ip'
        db.add_column(u'dir_searchlog_lv', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_pt.ip'
        db.add_column(u'dir_searchlog_pt', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_pl.ip'
        db.add_column(u'dir_searchlog_pl', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_fi.ip'
        db.add_column(u'dir_searchlog_fi', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_no.ip'
        db.add_column(u'dir_searchlog_no', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_nl.ip'
        db.add_column(u'dir_searchlog_nl', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_ro.ip'
        db.add_column(u'dir_searchlog_ro', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_it.ip'
        db.add_column(u'dir_searchlog_it', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_is.ip'
        db.add_column(u'dir_searchlog_is', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_hu.ip'
        db.add_column(u'dir_searchlog_hu', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_hr.ip'
        db.add_column(u'dir_searchlog_hr', 'ip',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchLog_da.ip'
        db.delete_column(u'dir_searchlog_da', 'ip')

        # Deleting field 'SearchLog_de.ip'
        db.delete_column(u'dir_searchlog_de', 'ip')

        # Deleting field 'SearchLog_tr.ip'
        db.delete_column(u'dir_searchlog_tr', 'ip')

        # Deleting field 'SearchLog_cs.ip'
        db.delete_column(u'dir_searchlog_cs', 'ip')

        # Deleting field 'SearchLog.ip'
        db.delete_column(u'dir_searchlog', 'ip')

        # Deleting field 'SearchLog_sw.ip'
        db.delete_column(u'dir_searchlog_sw', 'ip')

        # Deleting field 'SearchLog_sv.ip'
        db.delete_column(u'dir_searchlog_sv', 'ip')

        # Deleting field 'SearchLog_sl.ip'
        db.delete_column(u'dir_searchlog_sl', 'ip')

        # Deleting field 'SearchLog_fr.ip'
        db.delete_column(u'dir_searchlog_fr', 'ip')

        # Deleting field 'SearchLog_sk.ip'
        db.delete_column(u'dir_searchlog_sk', 'ip')

        # Deleting field 'SearchLog_el.ip'
        db.delete_column(u'dir_searchlog_el', 'ip')

        # Deleting field 'SearchLog_es.ip'
        db.delete_column(u'dir_searchlog_es', 'ip')

        # Deleting field 'SearchLog_et.ip'
        db.delete_column(u'dir_searchlog_et', 'ip')

        # Deleting field 'SearchLog_lt.ip'
        db.delete_column(u'dir_searchlog_lt', 'ip')

        # Deleting field 'SearchLog_lv.ip'
        db.delete_column(u'dir_searchlog_lv', 'ip')

        # Deleting field 'SearchLog_pt.ip'
        db.delete_column(u'dir_searchlog_pt', 'ip')

        # Deleting field 'SearchLog_pl.ip'
        db.delete_column(u'dir_searchlog_pl', 'ip')

        # Deleting field 'SearchLog_fi.ip'
        db.delete_column(u'dir_searchlog_fi', 'ip')

        # Deleting field 'SearchLog_no.ip'
        db.delete_column(u'dir_searchlog_no', 'ip')

        # Deleting field 'SearchLog_nl.ip'
        db.delete_column(u'dir_searchlog_nl', 'ip')

        # Deleting field 'SearchLog_ro.ip'
        db.delete_column(u'dir_searchlog_ro', 'ip')

        # Deleting field 'SearchLog_it.ip'
        db.delete_column(u'dir_searchlog_it', 'ip')

        # Deleting field 'SearchLog_is.ip'
        db.delete_column(u'dir_searchlog_is', 'ip')

        # Deleting field 'SearchLog_hu.ip'
        db.delete_column(u'dir_searchlog_hu', 'ip')

        # Deleting field 'SearchLog_hr.ip'
        db.delete_column(u'dir_searchlog_hr', 'ip')
