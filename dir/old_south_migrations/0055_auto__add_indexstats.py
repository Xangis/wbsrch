...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndexStats'
        db.create_table(u'dir_indexstats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num_excluded', self.gf('django.db.models.fields.IntegerField')()),
            ('langs', self.gf('django.db.models.fields.TextField')()),
            ('total_urls', self.gf('django.db.models.fields.IntegerField')()),
            ('total_indexes', self.gf('django.db.models.fields.IntegerField')()),
            ('total_pendingindexes', self.gf('django.db.models.fields.IntegerField')()),
            ('create_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['IndexStats'])


    def backwards(self, orm):
        # Deleting model 'IndexStats'
        db.delete_table(u'dir_indexstats')
