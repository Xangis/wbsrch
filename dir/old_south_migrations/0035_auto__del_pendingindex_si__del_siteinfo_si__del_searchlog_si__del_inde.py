...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table(u'dir_pendingindex_si', u'dir_pendingindex_sl')

        # Renaming model 'SiteInfo_si'
        db.rename_table(u'dir_siteinfo_si', u'dir_siteinfo_sl')

        # Renaming model 'SearchLog_si'
        db.rename_table(u'dir_searchlog_si', u'dir_searchlog_sl')

        # Renaming model 'IndexTerm_si'
        db.rename_table(u'dir_indexterm_si', u'dir_indexterm_sl')

    def backwards(self, orm):
        # Renaming model 'PendingIndex_si'
        db.rename_table(u'dir_pendingindex_sl', u'dir_pendingindex_si')

        # Renaming model 'SiteInfo_si'
        db.rename_table(u'dir_siteinfo_sl', u'dir_siteinfo_si')

        # Renaming model 'SearchLog_si'
        db.rename_table(u'dir_searchlog_sl', u'dir_searchlog_si')

        # Renaming model 'IndexTerm_si'
        db.rename_table(u'dir_indexterm_sl', u'dir_indexterm_si')
