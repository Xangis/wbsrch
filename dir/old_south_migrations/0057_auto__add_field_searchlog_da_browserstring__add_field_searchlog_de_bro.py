...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchLog_da.browserstring'
        db.add_column(u'dir_searchlog_da', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_de.browserstring'
        db.add_column(u'dir_searchlog_de', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_tr.browserstring'
        db.add_column(u'dir_searchlog_tr', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_cs.browserstring'
        db.add_column(u'dir_searchlog_cs', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog.browserstring'
        db.add_column(u'dir_searchlog', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sw.browserstring'
        db.add_column(u'dir_searchlog_sw', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sv.browserstring'
        db.add_column(u'dir_searchlog_sv', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sl.browserstring'
        db.add_column(u'dir_searchlog_sl', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_fr.browserstring'
        db.add_column(u'dir_searchlog_fr', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_sk.browserstring'
        db.add_column(u'dir_searchlog_sk', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_el.browserstring'
        db.add_column(u'dir_searchlog_el', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_es.browserstring'
        db.add_column(u'dir_searchlog_es', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_et.browserstring'
        db.add_column(u'dir_searchlog_et', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_lt.browserstring'
        db.add_column(u'dir_searchlog_lt', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_lv.browserstring'
        db.add_column(u'dir_searchlog_lv', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_pt.browserstring'
        db.add_column(u'dir_searchlog_pt', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_pl.browserstring'
        db.add_column(u'dir_searchlog_pl', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_fi.browserstring'
        db.add_column(u'dir_searchlog_fi', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_no.browserstring'
        db.add_column(u'dir_searchlog_no', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_nl.browserstring'
        db.add_column(u'dir_searchlog_nl', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_ro.browserstring'
        db.add_column(u'dir_searchlog_ro', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_it.browserstring'
        db.add_column(u'dir_searchlog_it', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_is.browserstring'
        db.add_column(u'dir_searchlog_is', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_hu.browserstring'
        db.add_column(u'dir_searchlog_hu', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SearchLog_hr.browserstring'
        db.add_column(u'dir_searchlog_hr', 'browserstring',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchLog_da.browserstring'
        db.delete_column(u'dir_searchlog_da', 'browserstring')

        # Deleting field 'SearchLog_de.browserstring'
        db.delete_column(u'dir_searchlog_de', 'browserstring')

        # Deleting field 'SearchLog_tr.browserstring'
        db.delete_column(u'dir_searchlog_tr', 'browserstring')

        # Deleting field 'SearchLog_cs.browserstring'
        db.delete_column(u'dir_searchlog_cs', 'browserstring')

        # Deleting field 'SearchLog.browserstring'
        db.delete_column(u'dir_searchlog', 'browserstring')

        # Deleting field 'SearchLog_sw.browserstring'
        db.delete_column(u'dir_searchlog_sw', 'browserstring')

        # Deleting field 'SearchLog_sv.browserstring'
        db.delete_column(u'dir_searchlog_sv', 'browserstring')

        # Deleting field 'SearchLog_sl.browserstring'
        db.delete_column(u'dir_searchlog_sl', 'browserstring')

        # Deleting field 'SearchLog_fr.browserstring'
        db.delete_column(u'dir_searchlog_fr', 'browserstring')

        # Deleting field 'SearchLog_sk.browserstring'
        db.delete_column(u'dir_searchlog_sk', 'browserstring')

        # Deleting field 'SearchLog_el.browserstring'
        db.delete_column(u'dir_searchlog_el', 'browserstring')

        # Deleting field 'SearchLog_es.browserstring'
        db.delete_column(u'dir_searchlog_es', 'browserstring')

        # Deleting field 'SearchLog_et.browserstring'
        db.delete_column(u'dir_searchlog_et', 'browserstring')

        # Deleting field 'SearchLog_lt.browserstring'
        db.delete_column(u'dir_searchlog_lt', 'browserstring')

        # Deleting field 'SearchLog_lv.browserstring'
        db.delete_column(u'dir_searchlog_lv', 'browserstring')

        # Deleting field 'SearchLog_pt.browserstring'
        db.delete_column(u'dir_searchlog_pt', 'browserstring')

        # Deleting field 'SearchLog_pl.browserstring'
        db.delete_column(u'dir_searchlog_pl', 'browserstring')

        # Deleting field 'SearchLog_fi.browserstring'
        db.delete_column(u'dir_searchlog_fi', 'browserstring')

        # Deleting field 'SearchLog_no.browserstring'
        db.delete_column(u'dir_searchlog_no', 'browserstring')

        # Deleting field 'SearchLog_nl.browserstring'
        db.delete_column(u'dir_searchlog_nl', 'browserstring')

        # Deleting field 'SearchLog_ro.browserstring'
        db.delete_column(u'dir_searchlog_ro', 'browserstring')

        # Deleting field 'SearchLog_it.browserstring'
        db.delete_column(u'dir_searchlog_it', 'browserstring')

        # Deleting field 'SearchLog_is.browserstring'
        db.delete_column(u'dir_searchlog_is', 'browserstring')

        # Deleting field 'SearchLog_hu.browserstring'
        db.delete_column(u'dir_searchlog_hu', 'browserstring')

        # Deleting field 'SearchLog_hr.browserstring'
        db.delete_column(u'dir_searchlog_hr', 'browserstring')
