...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangelogItem'
        db.create_table(u'dir_changelogitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True)),
            ('num_urls_crawled', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('num_terms_indexed', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('num_domains_blocked', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['ChangelogItem'])


    def backwards(self, orm):
        # Deleting model 'ChangelogItem'
        db.delete_table(u'dir_changelogitem')
