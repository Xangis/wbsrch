...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PendingIndex_si'
        db.create_table(u'dir_pendingindex_si', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_si'])

        # Adding model 'SiteInfo_si'
        db.create_table(u'dir_siteinfo_si', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_si'])

        # Adding model 'SearchLog_si'
        db.create_table(u'dir_searchlog_si', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SearchLog_si'])

        # Adding model 'IndexTerm_si'
        db.create_table(u'dir_indexterm_si', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
        ...
        db.send_create_signal(u'dir', ['IndexTerm_si'])


    def backwards(self, orm):
        # Deleting model 'PendingIndex_si'
        db.delete_table(u'dir_pendingindex_si')

        # Deleting model 'SiteInfo_si'
        db.delete_table(u'dir_siteinfo_si')

        # Deleting model 'SearchLog_si'
        db.delete_table(u'dir_searchlog_si')

        # Deleting model 'IndexTerm_si'
        db.delete_table(u'dir_indexterm_si')
