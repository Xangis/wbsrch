...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SiteInfo_it'
        db.create_table(u'dir_siteinfo_it', (
        ...
        db.send_create_signal(u'dir', ['SiteInfo_it'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SiteInfo_it'
        db.delete_table(u'dir_siteinfo_it')
