...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SearchLog_tr'
        db.create_table(u'dir_searchlog_tr', (
        ...
        db.send_create_signal(u'dir', ['SearchLog_tr'])

        # Adding model 'PendingIndex_tr'
        db.create_table(u'dir_pendingindex_tr', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_tr'])

        # Adding model 'SearchLog_lt'
        db.create_table(u'dir_searchlog_lt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('search_count', self.gf('django.db.models.fields.IntegerField')()),
            ('result_count', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'dir', ['SearchLog_lt'])

        # Adding model 'SearchLog_lv'
        db.create_table(u'dir_searchlog_lv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')(unique=True)),
            ('search_count', self.gf('django.db.models.fields.IntegerField')()),
            ('result_count', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'dir', ['SearchLog_lv'])

        # Adding model 'SiteInfo_lt'
        db.create_table(u'dir_siteinfo_lt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_lt'])

        # Adding model 'SiteInfo_lv'
        db.create_table(u'dir_siteinfo_lv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rooturl', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('url', self.gf('django.db.models.fields.TextField')(unique=True, blank=True)),
            ('lastcrawled', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_lv'])

        # Adding model 'SiteInfo_tr'
        db.create_table(u'dir_siteinfo_tr', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rooturl', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('url', self.gf('django.db.models.fields.TextField')(unique=True, blank=True)),
            ('lastcrawled', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_tr'])

        # Adding model 'PendingIndex_lv'
        db.create_table(u'dir_pendingindex_lv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_lv'])

        # Adding model 'PendingIndex_lt'
        db.create_table(u'dir_pendingindex_lt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_lt'])

        # Adding model 'IndexTerm_lt'
        db.create_table(u'dir_indexterm_lt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
        ...
        db.send_create_signal(u'dir', ['IndexTerm_lt'])

        # Adding model 'IndexTerm_lv'
        db.create_table(u'dir_indexterm_lv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_indexed', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('page_rankings', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'dir', ['IndexTerm_lv'])

        # Adding model 'IndexTerm_tr'
        db.create_table(u'dir_indexterm_tr', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_indexed', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('page_rankings', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'dir', ['IndexTerm_tr'])


    def backwards(self, orm):
        # Deleting model 'SearchLog_tr'
        db.delete_table(u'dir_searchlog_tr')

        # Deleting model 'PendingIndex_tr'
        db.delete_table(u'dir_pendingindex_tr')

        # Deleting model 'SearchLog_lt'
        db.delete_table(u'dir_searchlog_lt')

        # Deleting model 'SearchLog_lv'
        db.delete_table(u'dir_searchlog_lv')

        # Deleting model 'SiteInfo_lt'
        db.delete_table(u'dir_siteinfo_lt')

        # Deleting model 'SiteInfo_lv'
        db.delete_table(u'dir_siteinfo_lv')

        # Deleting model 'SiteInfo_tr'
        db.delete_table(u'dir_siteinfo_tr')

        # Deleting model 'PendingIndex_lv'
        db.delete_table(u'dir_pendingindex_lv')

        # Deleting model 'PendingIndex_lt'
        db.delete_table(u'dir_pendingindex_lt')

        # Deleting model 'IndexTerm_lt'
        db.delete_table(u'dir_indexterm_lt')

        # Deleting model 'IndexTerm_lv'
        db.delete_table(u'dir_indexterm_lv')

        # Deleting model 'IndexTerm_tr'
        db.delete_table(u'dir_indexterm_tr')
