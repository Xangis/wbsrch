...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackItem.language'
        db.add_column(u'dir_feedbackitem', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedbackItem.language'
        db.delete_column(u'dir_feedbackitem', 'language')
