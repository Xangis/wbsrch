...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainInfo.rank_adjustment'
        db.add_column(u'dir_domaininfo', 'rank_adjustment',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'DomainInfo.rank_reason'
        db.add_column(u'dir_domaininfo', 'rank_reason',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainInfo.rank_adjustment'
        db.delete_column(u'dir_domaininfo', 'rank_adjustment')

        # Deleting field 'DomainInfo.rank_reason'
        db.delete_column(u'dir_domaininfo', 'rank_reason')
