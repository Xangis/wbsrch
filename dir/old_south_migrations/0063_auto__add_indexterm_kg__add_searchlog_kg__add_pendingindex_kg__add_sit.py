...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndexTerm_kg'
        db.create_table(u'dir_indexterm_kg', (
        ...
        db.send_create_signal(u'dir', ['IndexTerm_kg'])

        # Adding model 'SearchLog_kg'
        db.create_table(u'dir_searchlog_kg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SearchLog_kg'])

        # Adding model 'PendingIndex_kg'
        db.create_table(u'dir_pendingindex_kg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_kg'])

        # Adding model 'SiteInfo_kg'
        db.create_table(u'dir_siteinfo_kg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_kg'])


    def backwards(self, orm):
        # Deleting model 'IndexTerm_kg'
        db.delete_table(u'dir_indexterm_kg')

        # Deleting model 'SearchLog_kg'
        db.delete_table(u'dir_searchlog_kg')

        # Deleting model 'PendingIndex_kg'
        db.delete_table(u'dir_pendingindex_kg')

        # Deleting model 'SiteInfo_kg'
        db.delete_table(u'dir_siteinfo_kg')
