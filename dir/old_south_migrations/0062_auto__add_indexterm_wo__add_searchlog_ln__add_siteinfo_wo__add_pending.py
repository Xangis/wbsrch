...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndexTerm_wo'
        db.create_table(u'dir_indexterm_wo', (
        ...
        db.send_create_signal(u'dir', ['IndexTerm_wo'])

        # Adding model 'SearchLog_ln'
        db.create_table(u'dir_searchlog_ln', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SearchLog_ln'])

        # Adding model 'SiteInfo_wo'
        db.create_table(u'dir_siteinfo_wo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_wo'])

        # Adding model 'PendingIndex_wo'
        db.create_table(u'dir_pendingindex_wo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_wo'])

        # Adding model 'SearchLog_wo'
        db.create_table(u'dir_searchlog_wo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.TextField')()),
            ('result_count', self.gf('django.db.models.fields.IntegerField')()),
            ('last_search', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['SearchLog_wo'])

        # Adding model 'SiteInfo_ln'
        db.create_table(u'dir_siteinfo_ln', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rooturl', self.gf('django.db.models.fields.CharField')(max_length=260, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=2048, blank=True)),
            ('pagetitle', self.gf('django.db.models.fields.CharField')(max_length=260, null=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_ln'])

        # Adding model 'PendingIndex_ln'
        db.create_table(u'dir_pendingindex_ln', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_ln'])

        # Adding model 'IndexTerm_ln'
        db.create_table(u'dir_indexterm_ln', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('page_rankings', self.gf('django.db.models.fields.TextField')()),
        ...
        db.send_create_signal(u'dir', ['IndexTerm_ln'])


    def backwards(self, orm):
        # Deleting model 'IndexTerm_wo'
        db.delete_table(u'dir_indexterm_wo')

        # Deleting model 'SearchLog_ln'
        db.delete_table(u'dir_searchlog_ln')

        # Deleting model 'SiteInfo_wo'
        db.delete_table(u'dir_siteinfo_wo')

        # Deleting model 'PendingIndex_wo'
        db.delete_table(u'dir_pendingindex_wo')

        # Deleting model 'SearchLog_wo'
        db.delete_table(u'dir_searchlog_wo')

        # Deleting model 'SiteInfo_ln'
        db.delete_table(u'dir_siteinfo_ln')

        # Deleting model 'PendingIndex_ln'
        db.delete_table(u'dir_pendingindex_ln')

        # Deleting model 'IndexTerm_ln'
        db.delete_table(u'dir_indexterm_ln')
