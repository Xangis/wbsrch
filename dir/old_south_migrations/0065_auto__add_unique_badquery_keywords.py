...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BadQuery', fields ['keywords']
        db.create_unique(u'dir_badquery', ['keywords'])


    def backwards(self, orm):
        # Removing unique constraint on 'BadQuery', fields ['keywords']
        db.delete_unique(u'dir_badquery', ['keywords'])
