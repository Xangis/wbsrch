...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainInfo.is_unblockable'
        db.add_column(u'dir_domaininfo', 'is_unblockable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainInfo.is_unblockable'
        db.delete_column(u'dir_domaininfo', 'is_unblockable')
