...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteInfo.pagecontents'
        db.alter_column(u'site_info', 'pagecontents', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SiteInfo.pagefirstheadtag'
        db.alter_column(u'site_info', 'pagefirstheadtag', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'SiteInfo.pagecontents'
        db.alter_column(u'site_info', 'pagecontents', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'SiteInfo.pagetitle'
        db.alter_column(u'site_info', 'pagetitle', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'SiteInfo.pagedescription'
        db.alter_column(u'site_info', 'pagedescription', self.gf('django.db.models.fields.TextField')(default=''))
