...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonthlySearchReport'
        db.create_table(u'dir_monthlysearchreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('total_searches', self.gf('django.db.models.fields.IntegerField')()),
            ('month', self.gf('django.db.models.fields.IntegerField')()),
            ('year', self.gf('django.db.models.fields.IntegerField')()),
            ('top_searches', self.gf('django.db.models.fields.TextField')()),
            ('create_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['MonthlySearchReport'])


    def backwards(self, orm):
        # Deleting model 'MonthlySearchReport'
        db.delete_table(u'dir_monthlysearchreport')
