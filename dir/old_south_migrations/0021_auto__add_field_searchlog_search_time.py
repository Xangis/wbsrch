...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SearchLog.search_time'
        db.add_column(u'dir_searchlog', 'search_time',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SearchLog.search_time'
        db.delete_column(u'dir_searchlog', 'search_time')
