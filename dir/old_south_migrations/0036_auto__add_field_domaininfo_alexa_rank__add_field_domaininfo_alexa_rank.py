...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainInfo.alexa_rank'
        db.add_column(u'dir_domaininfo', 'alexa_rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DomainInfo.alexa_rank_date'
        db.add_column(u'dir_domaininfo', 'alexa_rank_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainInfo.alexa_rank'
        db.delete_column(u'dir_domaininfo', 'alexa_rank')

        # Deleting field 'DomainInfo.alexa_rank_date'
        db.delete_column(u'dir_domaininfo', 'alexa_rank_date')
