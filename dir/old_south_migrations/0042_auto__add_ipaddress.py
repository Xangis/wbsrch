...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dir_ipaddress', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16)),
            ('spam_commenter', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'dir', ['IPAddress'])


    def backwards(self, orm):
        # Deleting model 'IPAddress'
        db.delete_table(u'dir_ipaddress')
