...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IndexTerm_et'
        db.create_table(u'dir_indexterm_et', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_indexed', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'dir', ['IndexTerm_et'])

        # Adding model 'SiteInfo_et'
        db.create_table(u'dir_siteinfo_et', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_et'])

        # Adding model 'SearchLog_et'
        db.create_table(u'dir_searchlog_et', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SearchLog_et'])

        # Adding model 'PendingIndex_et'
        db.create_table(u'dir_pendingindex_et', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_et'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'dir_indexterm_ee', (
            ('num_results', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('page_rankings', self.gf('django.db.models.fields.TextField')()),
            ('keywords', self.gf('django.db.models.fields.CharField')(max_length=240, unique=True)),
            ('index_time', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=1, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_indexed', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        ...
        # Deleting model 'IndexTerm_et'
        db.delete_table(u'dir_indexterm_et')

        # Deleting model 'SiteInfo_et'
        db.delete_table(u'dir_siteinfo_et')

        # Deleting model 'SearchLog_et'
        db.delete_table(u'dir_searchlog_et')

        # Deleting model 'PendingIndex_et'
        db.delete_table(u'dir_pendingindex_et')
