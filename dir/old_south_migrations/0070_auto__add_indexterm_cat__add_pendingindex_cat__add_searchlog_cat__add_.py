...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndexTerm_cat'
        db.create_table(u'dir_indexterm_cat', (
        ...
        db.send_create_signal(u'dir', ['IndexTerm_cat'])

        # Adding model 'PendingIndex_cat'
        db.create_table(u'dir_pendingindex_cat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(unique=True, max_length=240)),
            ('date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dir', ['PendingIndex_cat'])

        # Adding model 'SearchLog_cat'
        db.create_table(u'dir_searchlog_cat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SearchLog_cat'])

        # Adding model 'SiteInfo_cat'
        db.create_table(u'dir_siteinfo_cat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'dir', ['SiteInfo_cat'])


    def backwards(self, orm):
        # Deleting model 'IndexTerm_cat'
        db.delete_table(u'dir_indexterm_cat')

        # Deleting model 'PendingIndex_cat'
        db.delete_table(u'dir_pendingindex_cat')

        # Deleting model 'SearchLog_cat'
        db.delete_table(u'dir_searchlog_cat')

        # Deleting model 'SiteInfo_cat'
        db.delete_table(u'dir_siteinfo_cat')
    ...
    models = {
        ...
        u'dir.indexterm_cat': {
            'Meta': {'object_name': 'IndexTerm_cat'},
            'actively_blocked': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_indexed': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index_time': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '8', 'decimal_places': '2', 'blank': 'True'}),
        ...
        u'dir.pendingindex_cat': {
            'Meta': {'object_name': 'PendingIndex_cat'},
            'date_added': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywords': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '240'})
        },
        ...
        u'dir.searchlog_cat': {
            'Meta': {'object_name': 'SearchLog_cat'},
            'browserstring': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indexed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ip': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'}),
