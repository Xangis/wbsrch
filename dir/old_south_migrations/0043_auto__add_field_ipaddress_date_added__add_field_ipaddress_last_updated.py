...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IPAddress.date_added'
        db.add_column(u'dir_ipaddress', 'date_added',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 1, 19, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'IPAddress.last_updated'
        db.add_column(u'dir_ipaddress', 'last_updated',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2014, 1, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IPAddress.date_added'
        db.delete_column(u'dir_ipaddress', 'date_added')

        # Deleting field 'IPAddress.last_updated'
        db.delete_column(u'dir_ipaddress', 'last_updated')
