...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'dir_indexterm_fr', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_fi.date_indexed'
        db.alter_column(u'dir_indexterm_fi', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_no.date_indexed'
        db.alter_column(u'dir_indexterm_no', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_nl.date_indexed'
        db.alter_column(u'dir_indexterm_nl', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_es.date_indexed'
        db.alter_column(u'dir_indexterm_es', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_et.date_indexed'
        db.alter_column(u'dir_indexterm_et', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_it.date_indexed'
        db.alter_column(u'dir_indexterm_it', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_is.date_indexed'
        db.alter_column(u'dir_indexterm_is', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_pt.date_indexed'
        db.alter_column(u'dir_indexterm_pt', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_el.date_indexed'
        db.alter_column(u'dir_indexterm_el', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_pl.date_indexed'
        db.alter_column(u'dir_indexterm_pl', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_hu.date_indexed'
        db.alter_column(u'dir_indexterm_hu', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_hr.date_indexed'
        db.alter_column(u'dir_indexterm_hr', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_sw.date_indexed'
        db.alter_column(u'dir_indexterm_sw', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_sv.date_indexed'
        db.alter_column(u'dir_indexterm_sv', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_sl.date_indexed'
        db.alter_column(u'dir_indexterm_sl', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_sk.date_indexed'
        db.alter_column(u'dir_indexterm_sk', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_ro.date_indexed'
        db.alter_column(u'dir_indexterm_ro', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm.date_indexed'
        db.alter_column(u'dir_indexterm', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_da.date_indexed'
        db.alter_column(u'dir_indexterm_da', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_de.date_indexed'
        db.alter_column(u'dir_indexterm_de', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_lt.date_indexed'
        db.alter_column(u'dir_indexterm_lt', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_lv.date_indexed'
        db.alter_column(u'dir_indexterm_lv', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_tr.date_indexed'
        db.alter_column(u'dir_indexterm_tr', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'IndexTerm_cs.date_indexed'
        db.alter_column(u'dir_indexterm_cs', 'date_indexed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'IndexTerm_et.date_indexed'
        db.alter_column(u'dir_indexterm_et', 'date_indexed', self.gf('django.db.models.fields.DateField')(auto_now=True))
        ...
        # Changing field 'IndexTerm_sl.date_indexed'
        db.alter_column(u'dir_indexterm_sl', 'date_indexed', self.gf('django.db.models.fields.DateField')(auto_now=True))
