...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DomainInfo.uses_language_query_parameter'
        db.add_column(u'dir_domaininfo', 'uses_language_query_parameter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DomainInfo.uses_language_query_parameter'
        db.delete_column(u'dir_domaininfo', 'uses_language_query_parameter')
