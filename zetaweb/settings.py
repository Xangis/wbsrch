...
ZETAWEB_HOST = os.getenv('ZETAWEB_HOST', '216.151.2.54')
URLS_HOST = os.getenv('URLS_HOST', '216.151.2.52')
INDEXES_HOST = os.getenv('INDEXES_HOST', '216.151.2.50')
LIVE_INDEXES_HOST = os.getenv('LIVE_INDEXES_HOST', '107.189.159.52')
LANGUAGE_PAGES_HOST = os.getenv('LANGUAGE_PAGES_HOST', '216.151.2.53')
LANGUAGE_INDEXES_HOST = os.getenv('LANGUAGE_INDEXES_HOST', '216.151.2.53')
NEWS_HOST = os.getenv('NEWS_HOST', '216.151.2.54')
...
('vo', gettext_noop('Volapük')),
('wa', gettext_noop('Walloon')),
