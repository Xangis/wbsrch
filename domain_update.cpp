...
int main(int argc, char* argv[]) {
   ...
   try {
      ...
      if (!redo ) {
          ...
          //SUPER SLOW: sql << "SELECT id, url, alexa_rank, domains_linking_in, domains_linking_in_last_updated FROM dir_domaininfo WHERE domains_linking_in_last_updated IS NULL ORDER BY url LIMIT ";
      } else {
